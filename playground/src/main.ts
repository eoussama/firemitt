...
function readForm(): TFormValues {
  return {
    ...
    themeText: getField("themeText").value,
    themePrimary: getField("themePrimary").value,
    themeSecondary: getField("themeSecondary").value,
    themeBackground: getField("themeBackground").value,
...
async function runAuth(): Promise<void> {
  ...
  const options = {
    ...
    config: {
      ...
      ...(values.themeText !== "#000000" || values.themePrimary !== "#000000" || values.themeSecondary !== "#000000" || values.themeBackground !== "#000000"
        ? {
            theme: {
              ...(values.themeText !== "#000000" ? { text: values.themeText } : {}),
              ...(values.themePrimary !== "#000000" ? { primary: values.themePrimary } : {}),
              ...(values.themeSecondary !== "#000000" ? { secondary: values.themeSecondary } : {}),
              ...(values.themeBackground !== "#000000" ? { background: values.themeBackground } : {}),
            },
          }
        : {}),
